  ...
  const sysapps = [
    {
      ...
      settings: [
        ...
        { id: '@chavy_boxjs_userCfgs.debugger_webs', name: '调试地址', val: 'Dev体验,https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/HTML/boxjs.html', type: 'textarea', placeholder: '每行一个配置，用逗号分割每个配置的名字和链接：配置,url', persistentHint:true, autoGrow: true, rows: 2, desc: '逗号分隔名字和链接, 回车分隔多个地址' },
      ...
      scripts: [
        {
          name: "抹掉：所有缓存",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Scripts/boxjs.revert.caches.js"
        },
        {
          name: "抹掉：收藏应用",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Scripts/boxjs.revert.usercfgs.favapps.js"
        },
        {
          name: "抹掉：用户偏好",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Scripts/boxjs.revert.usercfgs.js"
        },
        {
          name: "抹掉：所有会话",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Scripts/boxjs.revert.usercfgs.sessions.js"
        },
        {
          name: "抹掉：所有备份",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Scripts/boxjs.revert.baks.js"
        },
        {
          name: "抹掉：BoxJs (注意备份)",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Scripts/boxjs.revert.boxjs.js"
        }
      ],
      author: '@chavyleung',
      repo: 'https://github.com/BOBOLAOSHIV587/zTest/blob/main/BoxJs/JS/Scripts/box.switcher.js',
      icons: [
    ...
    },
    {
      ...
      author: '@chavyleung',
      repo: 'https://github.com/BOBOLAOSHIV587/Rules/blob/main/JS/BoxJs/JS/Scripts/box.switcher.js',
      icons: [
        'https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/Icons/AppIcons/Image/App/BoxSwitcher.mini.png',
        'https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/Icons/AppIcons/Image/App/BoxSwitcher.png'
      ],
      script: 'https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Scripts/box.switcher.js'
    },
    {
      id: "BoxGist",
      name: "Gist备份",
      ...
      author: "@dompling",
      repo: "https://github.com/BOBOLAOSHIV587/Rules/tree/main/JS/BoxJs/JS/Gist",
      icons: [
        "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/Icons/AppIcons/Image/App/github-bf.png",
        "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/Icons/AppIcons/Image/App/github-bf.png"
      ],
      descs_html: [
        "<h2>Token的获取方式</h2>",
      ...
      scripts: [
        {
          name: "备份 Gist",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Gist/backup.js"
        },
        {
          name: "从 Gist 恢复",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Gist/restore.js"
        },
        {
          name: "更新历史版本",
          script: "https://raw.githubusercontent.com/BOBOLAOSHIV587/Rules/main/JS/BoxJs/JS/Gist/commit.js"
        }
      ],
      settings: [
        {
